...
user_2 = User.create! first_name: 'Camilo', last_name: 'Farfán', email:'camilo.farfanp@gmail.com', password: 'camilo123', password_confirmation:'camilo123', role: 0, enabled: true
